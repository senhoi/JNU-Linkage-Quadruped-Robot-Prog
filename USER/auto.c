...
void InitAutoData(void)
{
	...
	sResumeLeftPoint_1[1].forward_val = 65;
	...
	sResumeLeftPoint_1[3].forward_val = 80;
	sResumeLeftPoint_1[3].turning_val = -128;

	sResumeLeftPoint_1[4].end_time = 10.0f;
	...
	sResumeRightPoint_1[0].forward_val = 65;
	...
	sResumeRightPoint_1[3].forward_val = 80;
	sResumeRightPoint_1[3].turning_val = 128;

	sResumeRightPoint_1[4].end_time = 10.0f;
	...
	sResumeLeftPoint_2[1].turning_val = 100;
	...
	sResumeLeftPoint_2[3].forward_val = 80;
	sResumeLeftPoint_2[3].turning_val = -128;

	sResumeLeftPoint_2[4].end_time = 7.0f;
	...
	sResumeRightPoint_2[3].forward_val = 80;
	sResumeRightPoint_2[3].turning_val = 128;

	sResumeRightPoint_2[4].end_time = 7.0f;
